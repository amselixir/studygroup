defmodule Workshop.Meta do
  ...
  @title "Amsterdam |> Elixir Studygroup week 002"
  ...
  @description """
  These are the assignments for week 2 of Amsterdams Elixir studygroup.
  In this week we learn more about Enumerables
  """
